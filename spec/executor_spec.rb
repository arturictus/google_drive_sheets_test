...
RSpec.describe Gat::Executor do
  ...
  before do
    ...
    VCR.use_cassette("executor_example_2_setup") do
  ...
  it "uploads the report to Google Sheets" do
    VCR.use_cassette("executor_example_2") do
    ...
    VCR.use_cassette("executor_example_2_read") do
  ...
  it "Try rerun executor" do
    VCR.use_cassette("executor_example_2_rewrite") do
      executor = Gat::Executor.new(@service, @spreadsheet_id)
